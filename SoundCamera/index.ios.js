...
/* ==============================
  ...
  // Screens / Pages
  var Index = require('./ReactApp/screens/main-tabs.ios');
...
/* ==============================
   ...
   *  Main View w/ Sidebar
   */
  var SoundCamera = React.createClass({
...
/* ==============================
  Done!
  =============================== */
  AppRegistry.registerComponent('SoundCamera', () => SoundCamera);
